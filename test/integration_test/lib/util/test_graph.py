...
def test_get_leaf_nodes():
    ...
    assert get_leaf_nodes('./test/integration_test/data/clean_data.json', './test/integration_test/data/graph_leaf_nodes.csv') == list1

    with open('./test/integration_test/data/graph_leaf_nodes.csv', 'r') as csv_file:
