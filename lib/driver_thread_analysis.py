...
mailbox_list = ['lkml', 'opensuse', 'opensuse-bugs', 'opensuse-factory', 'opensuse-features', 'opensuse-kernel']
...
for mailbox in mailbox_list:
    ...
    # generate_time_stats_threads(nodelist_filename, edgelist_filename, headers_filename, foldername+'/tables/')
    print("----------------")
